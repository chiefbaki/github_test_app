...
mixin _$UsersState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<UsersDto> users) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<UsersDto> users)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<UsersDto> users}) : _users = users;

  final List<UsersDto> _users;
  @override
  List<UsersDto> get users {
...
abstract class _Success implements UsersState {
  const factory _Success({required final List<UsersDto> users}) = _$SuccessImpl;
